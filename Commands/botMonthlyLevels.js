...
module.exports.run = async (bot, message, args, coreMessage, prefix) => {
    ...
    let entries = modules.createLevelsBoard(levels, userIDs, xp, amount, true, true)

    if (entries.join("\n\n").length > 2048) return message.channel.send(`That number is too high. I can't display that many entries.`)
    let embed = new Discord.MessageEmbed()
        .setColor(`5d10e9`)
        .setTitle(`Bot Leaderboard - Monthly Krystal Levels`)
...
module.exports.info = {
    name: `botmonthlylevels`,
    type: `krystal`,
    aliases: [`monthlybotlb`, `monthlybotleaderboard`, `monthlybotlevels`, `mblevels`, `botmonthly`],
    summary: `Shows a leaderboard of Krystal levels, as many entries as the parameter. This one is for the bot monthly levels.`,
    usage: `[entries]`,
